 ...
 * 
 */
Ext.define('Test8.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Test8.view.securityconfig.SecurityConfigController',
			'Test8.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
