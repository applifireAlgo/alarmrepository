Ext.define('Test8.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Test8.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Test8.view.console.ConsoleWindow');
