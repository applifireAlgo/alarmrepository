 ...
 * 
 */
Ext.define('Test8.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Test8.view.logalarm.LogAlarmMainViewController',
			'Test8.view.logalarm.tree.LogAlarmTreePanel',
			'Test8.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
