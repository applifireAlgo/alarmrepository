Ext.define('Test8.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Test8.view.usermanagement.admin.UserPasswordReset',
	            'Test8.view.usermanagement.admin.AddUserDetails',
	            'Test8.view.usermanagement.admin.ViewUser'],
