Ext.define("Test8.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Test8.view.clouddrive.CloudDriveController',
	             'Test8.view.clouddrive.documentview.DocumentsView',
	             'Test8.view.clouddrive.drivedetails.DriveDetails',
	             //'Test8.view.clouddrive.documentview.DocumentListView'
	             ],
