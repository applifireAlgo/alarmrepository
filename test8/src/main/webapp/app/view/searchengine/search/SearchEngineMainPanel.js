Ext.define('Test8.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Test8.view.searchengine.search.NorthPanel', 'Test8.view.searchengine.search.SearchResult','Test8.view.searchengine.search.SearchEngineMainPanelController'],
