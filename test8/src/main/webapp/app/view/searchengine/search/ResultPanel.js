Ext
		.define(
				'Test8.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Test8.view.searchengine.search.SearchEngineMainPanelController','Test8.view.searchengine.search.PanelHeaderField' ,'Test8.view.searchengine.search.ReportGridView','Test8.view.searchengine.search.ReportChartView','Test8.view.searchengine.search.documentView','Test8.view.searchengine.search.DouMeanView','Test8.view.googlemaps.map.MapPanel'],
