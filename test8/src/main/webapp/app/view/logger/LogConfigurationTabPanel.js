...
Ext
		.define(
				'Test8.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Test8.view.logger.tabs.details.DetailsTab',
							'Test8.view.logger.tabs.fileconnector.FileConnectorTab',
							'Test8.view.logger.tabs.dbconnector.DBConnectorTab',
							'Test8.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Test8.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Test8.view.logger.LogConfigurationTabPanelController',
