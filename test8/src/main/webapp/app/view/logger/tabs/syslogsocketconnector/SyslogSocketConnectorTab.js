 ...
 * 
 */
Ext.define('Test8.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Test8.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
