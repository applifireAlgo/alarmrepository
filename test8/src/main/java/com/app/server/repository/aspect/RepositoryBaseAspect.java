...
public class RepositoryBaseAspect extends RepositoryAspect{
	...
	@Pointcut("(execution(* com.athena..repository..*(..)) || execution(* com.spartan..repository..*(..))) && !within(com.athena.server.repository.ArtQueryRepository+) && !within(com.athena.alarm..*)")
