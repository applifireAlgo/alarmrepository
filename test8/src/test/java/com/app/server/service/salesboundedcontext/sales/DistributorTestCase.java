...
public class DistributorTestCase extends EntityTestCriteria {
    ...
    private Distributor createDistributor(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        salesregion.setRegionname("Z2zelkqNCRW1HTrWCTbYviJwwCJOcMkGHiWPG3tTgYZCs3mnbR");
        ...
        distributor.setLongitude(3900.0d);
        distributor.setLattitude(3900.0d);
        distributor.setDistributorname("WuNQ9P6Q7JS1guES3ARHH5LfQsuIUOgLBfAJS9hfUDZpeNEvEW");
    ...
    public void test2Update() {
        try {
            ...
            distributor.setLongitude(4600.0d);
            distributor.setLattitude(9100.0d);
            distributor.setDistributorname("IFlesCJRBOJ1T9cq2cFXKRk432VnY136bYnrI7uK4VCKkfejqg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "distributorname", "6OXv2M1C98a6q8oMtsrM32OXFwfiaAvRgcOFivEEB2Akeq09iTnG7qwzhbUuwMxhb"));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "longitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "longitude", 1.3869597522152466E19d));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 5, "lattitude", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "lattitude", 1.5465245967290851E19d));
