...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("1ETU9bCNr2KfCmbLWT9WK6IDqGo4o4czz0f5mqnBHkLXV9Buzo");
        question.setQuestion("W9UAtanfZd685A5P7Ii57RcYuiFYyHD2VpKO7hbUbwtnNea34M");
        question.setQuestionDetails("ARy9d18zM1");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("N9qq8qg8aGmLLyEtLLs5Dz9n2Ca7XLeu4V1C0GYbFXYfJVqL6l");
            question.setQuestion("c1tWiQf9519uIXnPGXYHBwSItKWlGjm6NZVuIxCes3gFB8SbK8");
            question.setVersionId(1);
            question.setQuestionDetails("fA1MybyfnB");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "79JNYKaPPR7UV4Aj2FZO0oqPWgvMFcimBcgP0UXUTIrnvuTABJ1NVpnFxjEcKDb0B"));
