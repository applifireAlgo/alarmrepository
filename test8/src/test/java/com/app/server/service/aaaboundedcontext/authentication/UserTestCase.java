...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainHelp("mkGHPt0Z6M6C8GUYYP8XSiLHmy7Z1qarb81UnUryKasn132MVJ");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("S3blvQSY9IbAK3xBasZnzKtl3ptNgwdUhdmaAWRjMFzw7lrT9N");
        useraccessdomain.setDomainDescription("qhseJXair5p5S48Kw3skb5f6gn4jdGhR4EESibi9n7TlObAc57");
        useraccessdomain.setDomainName("iPM2CFd0lzfaDq7I9KRJhJwVh2szCOWKItd0Di2ueW0nYYSibD");
        ...
        useraccesslevel.setLevelHelp("qn0ZTO4MwEwyWLpY5ACf6rZtIpLVlb7z9BNvv1O7ErBtmISGxb");
        useraccesslevel.setLevelDescription("b8CmYqZy5pumD1L9G9jFr5ygEK6ANsJ0hKrQvz0SJS7Kj8QXNQ");
        useraccesslevel.setLevelIcon("bxwURoeT4B4gMs8DYoSBnNbQYhu6knYrpZR1ZDGUw2kYXLpc5e");
        useraccesslevel.setLevelName("8I4isiJLZrJdOTgtGL0bEcTxxukJLYaFZWbJdSaTmJaDXsjEZL");
        ...
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1460104255895l));
        user.setAllowMultipleLogin(1);
        user.setSessionTimeout(552);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1460104255895l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setUserAccessCode(50020);
        user.setChangePasswordNextLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setPasswordAlgo("9Vzax17gH8LHYbN4xJE1KqwXzQ0q1tcGk3i8C7K0azCN8b5P9I");
        user.setMultiFactorAuthEnabled(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("820137uEOBB5bTZyyLl4AnBR6fbWqpq3bl3YYFkqeUrseqVtiV");
        question.setQuestion("5PrDDoY26xum4ufAGaLDxKtWRfkye4XypT7s3pLCTduPTpDGrQ");
        question.setQuestionDetails("F3UJHGU5XD");
        ...
        passrecovery.setAnswer("AcKmGBXzd0oSTYgYvw0GWTvvBFBVUlDDm05tklrPzBq3vl0Wvp");
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("c6BLz2MPUJ73RJ8qAZIRNINwnvPmzzUS");
        userdata.setOneTimePassword("udmzXCdqDunT6guIn26QTyLKUyqQHV9l");
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(1);
        userdata.setPassword("t2bJ8zgmxSxmA2ihhMNyPDu7wJcMtb3eIJia6YS9sMgLaFjSQ1");
        userdata.setLast5Passwords("6TumIW8dU7q6DtYkyd2r6Rn9Zp2e1fZ0paCYtVhE9jZGIQUIDP");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1460104256135l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 60992));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "zgYmDIY1iv2gV3qtvdyYR1dtzt7ZNGrdg6sElIWC9o5VVVvzJB6x7dCiQWbVlihtM"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5324));
